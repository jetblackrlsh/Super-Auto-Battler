...
Active lineup order matters, and the active team is capped at 4 heroes so the battle remains readable. The first active hero is the frontline and draws enemy fire with a defensive bonus, while the backline gets extra attack. Benched heroes remain owned and can still be upgraded or outfitted.
